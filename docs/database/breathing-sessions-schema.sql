...
-- Module: Exercices de Respiration Guidée
-- =====================================================
...
-- Fonction pour insérer des sessions de test (à exécuter manuellement)
-- INSERT INTO breathing_sessions (user_id, technique, duration_seconds, completed, stress_before, stress_after, feeling_after)
-- VALUES
-- ('user-uuid-here', 'coherence', 300, true, 8, 4, 'calmer'),
-- ('user-uuid-here', 'box', 180, true, 7, 3, 'better'),
-- ('user-uuid-here', 'quick', 120, false, 6, null, null);